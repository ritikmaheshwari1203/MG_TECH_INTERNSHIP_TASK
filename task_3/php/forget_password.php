    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($user_email==''){
            ...
            if($no_of_exist_rows>0){
                ...
                if(sendotp($user_email,$otp_genrate)){
                    session_start();
                    $_SESSION['email'] = $user_email;
                    $query=mysqli_query($conn,"update otptable set otp=$otp_genrate where email = '$user_email'");   
                    ...
                    header("location:verification_page_2.php");
                }
                else{
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <form action = '<?php htmlspecialchars($_SERVER["PHP_SELF"])?>' method = "post">
            ...
            <div class="mb-3">
                ...
                <div id="emailHelp" class="form-text">First verify is it you or not, we will share you OTP to resister Email address.</div>
            </div>
