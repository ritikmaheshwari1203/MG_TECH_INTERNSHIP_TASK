...
if(isset($_POST['submit']))
{
	...
	// echo $password;
$ret=mysqli_query($con,"SELECT * FROM admin WHERE email='$username' and super_admin=1");
...
<head>
	<title>Citizen Connect | Super Admin login</title>
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<h4>Ciziten Connect <hr /><span style="color:#fff;">Super Admin Login</span></h4>
